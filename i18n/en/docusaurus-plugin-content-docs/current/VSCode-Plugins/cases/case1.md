...
This example uses CoreMark to demonstrate the basic workflow of completing toolchain installation, virtual environment creation, source extraction, build, and execution within the extension. For detailed instructions, see [Building with Ruyi Compilation Environment](../../Package-Manager/cases/case1.md).
