...
- RuyiSDK core: If not installed, the extension will guide you through one‑click installation; manual installation and configuration are also possible. See [installation](../Package-Manager/installation.mdx).
...
For more concepts and CLI behavior, see [Ruyi Package Manager](../Package-Manager/index.md).
