# Sipeed Lichee Pi 4A: Build a C++ Hello World Project with the riscv64-plctxthead-linux-gnu Toolchain

## Preparing the Development Environment

1. Download Eclipse IDE for Embedded C/C++ Developers version 2024‑12 (4.34) and later: https://www.eclipse.org/downloads/packages/
1. Download and install the latest RuyiSDK IDE extension following the instructions on the download page: https://github.com/ruyisdk/ruyisdk-eclipse-plugins/releases/tag/continuous
...
## Test Environment Used in This Document
