...
function PageBackground({ isClient }) {
  ...
  return ReactDOM.createPortal(
    <div
      ...
      style={{ background: 'linear-gradient(180deg, #f7f9fc 0%, #ffffff 42%, #f6f8fb 100%)' }}
    />,
    document.body,
  );
}
  ...
  const toolItems = [
    {
      ...
      href: `#${SECTION_IDS.packageManager}`,
    },
    {
      ...
      href: `#${SECTION_IDS.vscodeExtension}`,
    },
    {
      ...
      href: `#${SECTION_IDS.eclipseExtension}`,
    },
  ];

  return (
    <section className="mb-8 rounded-lg border border-gray-200 bg-white shadow-lg overflow-hidden">
