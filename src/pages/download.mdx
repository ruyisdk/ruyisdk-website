...
+ 从 [GitHub Releases](https://github.com/ruyisdk/ruyisdk-eclipse-plugins/releases/)  或者[RuyiSDK 软件源](https://mirror.iscas.ac.cn/ruyisdk/ide/plugins/eclipse/) 下载最新插件包
+ 参考 [GitHub Releases](https://github.com/ruyisdk/ruyisdk-eclipse-plugins/releases/) 页面中对应版本的安装说明进行安装

### 安装 RuyiSDK VSCode 插件

从 [GitHub Releases](https://github.com/ruyisdk/ruyisdk-vscode-extension/releases) 或者[RuyiSDK 软件源](https://mirror.iscas.ac.cn/ruyisdk/ide/plugins/vscode/) 下载最新 .vsix，在 VS Code 或者 VS Codium 中选择 “从 VSIX 安装”。
