...
# 文档具有时效性，如示范链接无法下载，您可以从 [GitHub releases](https://github.com/ruyisdk/ruyi/releases) 或 [RuyiSDK 镜像](https://mirror.iscas.ac.cn/ruyisdk/ruyi/release/)中获取所有版本的预构建二进制文件
