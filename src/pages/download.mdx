...
```bash
$ wget https://mirror.iscas.ac.cn/ruyisdk/ruyi/releases/0.30.0/ruyi.amd64
```

如果输出为 ``aarch64``：

```bash
$ wget https://mirror.iscas.ac.cn/ruyisdk/ruyi/releases/0.30.0/ruyi.arm64
```

如果输出为 ``riscv64``：

```bash
$ wget https://mirror.iscas.ac.cn/ruyisdk/ruyi/releases/0.30.0/ruyi.riscv64
```
