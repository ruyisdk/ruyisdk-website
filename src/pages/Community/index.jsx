...
// --- Person Cards (CoreMemberCard updated) ---
...
export default function Community() {
    const partnersData = [ { id: 1, name: 'Milk-V', logoUrl: 'https://www.fedoravforce.org/partner-logo/milkv.png' }, { id: 2, name: 'Sipeed', logoUrl: 'https://www.fedoravforce.org/partner-logo/sipeed.png' }, { id: 3, name: 'Fedora-V Force', logoUrl: 'https://images.fedoravforce.org/images/fvf-logo.png' }, { id: 4, name: 'openEuler RISC-V sig', logoUrl: 'https://www.fedoravforce.org/partner-logo/openeuler.png' }, { id: 5, name: 'openKylin', logoUrl: 'https://www.openkylin.top/upload/202209/1664440595.png'}, ];
