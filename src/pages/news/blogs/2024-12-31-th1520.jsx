...
import Article from "@site/src/components/News/Blogs/2024-12-31-th1520";
import { BLOG_ARTICLES, getLocalizedArticleField } from "@site/src/components/News/Blogs/metadata";

const ARTICLE = BLOG_ARTICLES.find((item) => item.slug === "2024-12-31-th1520");

export default function Th1520BlogPage() {
