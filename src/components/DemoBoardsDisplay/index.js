...
const slideImages = [
  ...
  {
    title: " 嘉楠勘智K230D",
    subtitle: "首款基于新32位 RuyiSDK 的AIoT量产芯片",
...
const DemoBoardsDisplay = () => {

  return (
    <>
      <Flex gap="middle" justify="center" align="stretch" wrap="wrap" style={{ marginTop: "1rem" }}>
      ...
      <Flex gap="middle" justify="center" align="stretch" wrap="wrap" style={{ marginTop: "1rem" }} flex={1}>
        {slideImages.map((item, idx) =>
          <Card key={idx}
            className={styles.card}
            hoverable={true}
...
export default DemoBoardsDisplay