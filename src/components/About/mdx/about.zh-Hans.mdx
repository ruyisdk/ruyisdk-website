...
2. 开发者可以指定任何常用的 RISC-V 扩展指令集架构组合，都可以通过 RUYISDK 系统生成客户所需的操作系统、工具链、语言执行环境（运行时或虚拟机）、计算库、应用框架等。
3. 培育运营一个活跃全面的开发者交流社区。

## 我们的产品

- RISC-V 操作系统（XuanTie 芯片优化定制发行版）：[RevyOS](https://github.com/ruyisdk/revyos)
...
- 重点参与 RISC-V 适配和支持的软件：QEMU、Box64、LuaJIT、DynamoRIO
- RISC-V 图形化镜像刷写工具：[Ruyi Imager](/docs/Imager/)
...
邀请各位开发者填写RuyiSDK使用反馈问卷，助力工具迭代优化！

详情： [https://ruyisdk.cn/t/topic/2756/3](https://ruyisdk.cn/t/topic/2756/3)

<img src="/img/QRCode_img/ruyisdk_survey.webp" width="280" alt="问卷二维码" />
