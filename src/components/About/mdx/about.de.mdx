...
3. Aufbau und Betrieb einer aktiven, inklusiven Entwickler-Community.

## Unsere Produkte

- RISC-V-Betriebssystem (für XuanTie-Chips optimiert): [RevyOS](https://github.com/ruyisdk/revyos)
...
- RISC-V-Toolchains: `RuyiSDK-GCC`, `RuyiSDK-LLVM`
- Wesentliche upstream-Software, die in RuyiSDK integriert ist: QEMU, Box64, LuaJIT, DynamoRIO
