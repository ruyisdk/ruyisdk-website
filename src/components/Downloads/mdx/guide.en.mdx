...
### Install toolchains and a development environment
...
### Install an operating system on a board

[Ruyi Imager](#ruyi-imager) is a graphical image writer for Windows, Linux, and macOS. See the [user guide](/en/docs/Imager/) to get started.
